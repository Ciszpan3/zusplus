      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded">
            <h4 className="font-semibold text-amber-900 mb-2">Wzór uproszczony:</h4>
            <div className="bg-white p-4 rounded font-mono text-sm text-center">
              Emerytura = <span className="text-primary font-bold">Kapitał emerytalny</span> / <span className="text-secondary font-bold">Średnia długość życia</span>
            </div>
          </div>

          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-5 rounded-lg">
            <h4 className="font-semibold text-gray-900 mb-2">Co wpływa na wysokość emerytury?</h4>
